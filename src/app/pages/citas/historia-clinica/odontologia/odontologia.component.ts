...
export class OdontologiaComponent implements OnInit {
  ...
  odontologiaForm: FormGroup = this.fb.group({
    ...
    periapical1: [null, Validators.required],
    periapical2: [null, Validators.required],
    panoramica1: [null, Validators.required],
    panoramica2: [null, Validators.required],
    otra1: [null, Validators.required],
    otra2: [null, Validators.required],
    examenesLaboratorioOdonto1: [null, Validators.required],
    examenesLaboratorioOdonto2: [null, Validators.required],
  ...
  guardarHistoriaOdontologia() {
    const historiaOdontologia: any = {
      ...
      periapical1: this.odontologiaForm.get('periapical1').value,
      periapical2: this.odontologiaForm.get('periapical2').value,
      panoramica1: this.odontologiaForm.get('panoramica1').value,
      panoramica2: this.odontologiaForm.get('panoramica2').value,
      otra1: this.odontologiaForm.get('otra1').value,
      otra2: this.odontologiaForm.get('otra2').value,
      examenesLaboratorioOdonto1: this.odontologiaForm.get('examenesLaboratorioOdonto1').value,
      examenesLaboratorioOdonto2: this.odontologiaForm.get('examenesLaboratorioOdonto2').value,
